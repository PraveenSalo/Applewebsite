...
Files: macbook-14.glb [629.72KB] > /Users/salo/Documents/JESUS/Applewebsite/applewebsite/public/models/macbook-14-transformed.glb [627.9KB] (0%)
...
export default function MacBookModel14(props) {
  const { color = "#2e2c2e", ...rest } = props;
  const { nodes, materials } = useGLTF("/models/macbook-14-transformed.glb");
  const texture = useTexture("/screen.png");

  // Optional: gently tint common “body” materials if present
  useEffect(() => {
    const maybeTint = (name) => {
      if (materials?.[name]?.color) {
        materials[name].color.set(color);
      }
    };
    // Add/remove material keys as needed after you inspect your GLTF in the console
    ["PaletteMaterial001", "PaletteMaterial002"].forEach(maybeTint);
  }, [color, materials]);
  ...
  return (
    <group {...rest} dispose={null}>
      ...
      {/* Screen: use child material with texture; remove material prop */}
